...
async def inspect_visitor_5():
    async with AsyncSessionLocal() as db:
        ...
        # 2. Get details for some rejected properties
        rejected_addresses = [
            '284 IVEN AVE #1B-270-1B',
            '122 W LANCASTER AVE',
            '343 A SUGARTOWN RD #A'
        ]
        
        print("\n--- SAMPLE REJECTED PROPERTIES ---")
